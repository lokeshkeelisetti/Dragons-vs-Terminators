class Place(object):
    ...
    def add_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            if self.dragon is None:
                self.dragon = fighter
            elif self.dragon.is_container and not fighter.is_container:
            ...
            elif not self.dragon.is_container and fighter.is_container:
    ...
    def remove_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            ...
            # BEGIN 4.3
            if hasattr(fighter,'Trueking') and fighter.Trueking:
                return
            "*** YOUR CODE HERE ***"
            # END 4.3
